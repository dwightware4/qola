...
export const Hero = () => (
  <PageSection className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <Text as="h1" size="7xl" className="font-display font-medium tracking-tight">
        ...
        <span className="relative whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="fill-accent-300/70 absolute top-2/3 left-0 h-[0.58em] w-full"
    ...
    <div className="mt-10 flex justify-center gap-x-6">
      ...
      <Button target="_blank" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">
        <svg
          aria-hidden="true"
          className="h-3 w-3 flex-none fill-gray-300 group-active:fill-current"
        >
