...
import { ChartBarIcon, CheckCircleIcon, DocumentMagnifyingGlassIcon, UserIcon, WrenchScrewdriverIcon } from '@/icons'
    ...
    <div className="min-h-screen">
      ...
      <PageSection className="pt-12 pb-16 text-center">
        <div className="mx-auto max-w-4xl">
          <div className="mb-6">
            <UserIcon className="mx-auto h-16 w-16 text-accent-500" />
          </div>
